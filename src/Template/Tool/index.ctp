    ...
    <div class="columns large-6">
        ...
        <ul>
            <li class="bullet cutlery">
                <a target="_blank" href="<?= Router::url(['controller' => 'Tool', 'action' => 'clearCache']); ?>">Clear Cache</a>
            </li>
            <li class="bullet cutlery">
                <a target="_blank" href="<?= Router::url(['controller' => 'Tool', 'action' => 'excelExport']); ?>">Excel Export</a>
            </li>
            <li class="bullet cutlery">
                <a target="_blank" href="<?= Router::url(['controller' => 'Auth', 'action' => 'login']); ?>">Login</a>
            </li>
        </ul>
    </div>
    <div class="columns large-6">
...
<div class="row">
    <div class="columns large-6">
        <h4>Environment</h4>
        <ul>
            <li class="bullet success">Your version of PHP is <?= PHP_VERSION ?> (detected).</li>
...
<div class="row">
    <div class="columns large-12">
        ...
        <?php foreach (get_loaded_extensions() as $key => $extension): ?>
            <?php $aryExtension[] = $extension; ?>
        <?php endforeach; ?>
        <div class="pull-left">
            <?= implode('、', $aryExtension) ?>
        </div>
