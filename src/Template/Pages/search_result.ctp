...
<div class="page page_register register_confirm" id="account">
    <div class="navi">
        <div class="go_back">
            <a href="<?= Router::url('/pages/search12'); ?>">
    ...
    <div class="content">
        <div class="info">
            <div class="row">
                <div class="situation col-sm-8 col-lg-8">
                    ...
                    <label for="radio2"><input type="radio" value="作業予定日返信要" name="type" id="radio2" checked> 作業予定日返信要</label>
                    ...
                    <label for="radio5"><input type="radio" value="戻し条件" name="type" id="radio5"> 戻し条件</label>
                </div>
            </div>
            <div class="row">
                <div class="col-xl-1">案件No.</div>
                <div class="col-xl-1"><input type="text" class="input" placeholder="EK20181036"></div>
                <div class="col-xl-2">※連絡事項記載有り</div>
                <div class="col-xl-2">※添付資料有り</div>
                <div class="col-xl-1">訪問時間帯</div>
                <div class="col-xl-1"><input type="text" class="input text-right" placeholder="①便"></div>
                <div class="col-xl-1 text_notice">開始時間</div>
                <div class="col-xl-1"><input type="text" class="input"></div>
                <div class="col-xl-1 text_notice">終了時間</div>
                <div class="col-xl-1"><input type="text" class="input"></div>
            </div>
            <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-xl-3"><input type="text" class="input " placeholder="ﾔﾏﾓﾄｼｮｳﾃﾝ"></div>
                <div class="col-xl-2">様</div>
            ...
            <div class="row">
                ...
                <div class="col-xl-2"><input type="text" class="input " placeholder="ﾔﾏﾓﾄｼｮｳﾃﾝ"></div>
                <div class="col-xl-1">郵便番号</div>
                <div class="col-xl-2">
                ...
                <div class="col-xl-6 stock">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-4" >
                            <label for="" class="float-right"><input type="checkbox" checked> 確認しました</label>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="attack">
            <div class="row">
                ...
                <div class="col-xl-2">
                    <div class="row">
                        <label for=""><input type="checkbox" checked> 確認しました</label>
                    </div>
                    <div class="row">
                        <label for=""><input type="checkbox" checked> 確認しました</label>
                    </div>
                ...
                <div class="col-xl-2">
                    ...
                    <div class="row">
                        <label for=""><input type="checkbox" checked> 印刷しました</label>
                    </div>
                </div>
                <div class="col-xl-3">
                    <a href="" class="abt register">再送</a>
                    <a href="<?= Router::url('/pages/contact_list'); ?>" class="abt cancel">キャンセル</a>
                </div>
            </div>
