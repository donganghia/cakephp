...
<div class="page page_register register_confirm" id="account">
    <div class="navi">
        <div class="go_back">
            <a href="<?= Router::url( '/pages2/confirm_processing'); ?>">
    ...
    <div class="content">
        <div class="info">
            ...
            <div class="row">
                ...
                <div class="col-xl-6 color_red">連絡コメント
                    <a href="<?= Router::url( '/pages2/comment'); ?>">
        ...
        <div class="attack">
            <div class="row">
                ...
                <div class="col-xl-2">
                    <div class="row">
                        <a href="<?= Router::url( '/pages2/confirm_print'); ?>">
                ...
                <div class="col-xl-3">
                    <a href="<?= Router::url( '/pages2/confirm'); ?>" class="abt register">確認登録</a>
